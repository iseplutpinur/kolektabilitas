...
class JenisAsuransi extends Render_Controller
{
    ...
    public function index()
    {
        ...
        $this->navigation = ['Jenis Asuransi'];
        $this->plugins = ['datatables'];

        // Breadcrumb setting
        $this->breadcrumb_1 = 'Dashboard';
        $this->breadcrumb_1_url = base_url() . 'admin/dashboard';
        $this->breadcrumb_3 = 'Jenis Asuransi';
        $this->breadcrumb_3_url = '#';
        // content
        $this->content      = 'jenis_asuransi';
    ...
    public function insert()
    {
        ...
        $result = $this->model->insert($nama, $keterangan);
    ...
    public function update()
    {
        ...
        $nama = $this->input->post("nama");
        $keterangan = $this->input->post("keterangan");
        $result = $this->model->update($id, $nama, $keterangan);
        $code = $result ? 200 : 500;
        $this->output_json(["data" => $result], $code);
    }
    ...
    public function export_excel()
    {
        ...
        $col_start = "A";
        $col_end = "D";
        $title_excel = "List Jenis Asuransi";
        // Header excel ================================================================================================
        ...
        foreach ($details as $detail) {
            ...
            $sheet->setCellValue(chr(65 + ++$c) . "$row", $detail->id);
    ...
    public function form_import_excel()
    {
        ...
        $col_start = "A";
        $col_end = "F";
        $title_excel = "Form Import Data Jenis Asuransi";
        // Header excel ================================================================================================
        $spreadsheet = new PhpOffice\PhpSpreadsheet\Spreadsheet();
        $sheet = $spreadsheet->getActiveSheet();
        ...
        $row += 1;
        $sheet->mergeCells($col_start . $row . ":" . $col_end . $row)
            ->setCellValue("A$row", "Form Import Data Jenis Asuransi");
        $sheet->getStyle($col_start . $row . ":" . $col_end . $row)->applyFromArray([
            "font" => [
                "bold" => true,
                "size" => 13
    ...
    public function import_excel()
    {
        ...
        foreach ($array_from_excel as $data) {
            if ($start > 5) {
                ...
                $exe = $this->model->insert($nama, $keterangan, $id);
                if (!$exe) {
                    $result = false;
                }
            }
    ...
    function __construct()
    {
        ...
        $this->load->model("JenisAsuransiModel", 'model');
